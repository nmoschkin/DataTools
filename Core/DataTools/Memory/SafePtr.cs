...
namespace DataTools.Memory
{
    public class SafePtr : SafeHandle
    {
        ...
        public SafePtr(IntPtr ptr, int size, MemoryType t, bool fOwn) : base(0, fOwn)
        {
            handle = ptr;
            Size = size;
            MemoryType = t;
        ...
        public SafePtr(IntPtr ptr, long size) : base(0, false)
        {
            handle = ptr;
            Size = size;
        }

        public SafePtr(IntPtr ptr, int size) : base(0, false)
        {
            handle = ptr;
            Size = size;
        }

        public SafePtr(IntPtr ptr) : base(0, false)
        {
            handle = ptr;
        }

        public SafePtr(IntPtr ptr, bool fOwn) : base(0, fOwn)
        {
            handle = ptr;
            IsOwner = fOwn;
        }

        public SafePtr(IntPtr ptr, long size, bool fOwn) : base(0, fOwn)
        {
            handle = ptr;
            Size = size;
            IsOwner = fOwn;
        ...
        public SafePtr(IntPtr ptr, int size, bool fOwn) : base(0, fOwn)
        {
            handle = ptr;
            Size = size;
            IsOwner = fOwn;
        ...
        public unsafe SafePtr(void* ptr, int size) : base(0, false)
        {
            handle = (IntPtr)ptr;
            Size = size;
        }

        public unsafe SafePtr(void* ptr, long size) : base(0, false)
        {
            handle = (IntPtr)ptr;
            Size = size;
        }

        public unsafe SafePtr(void* ptr) : base(0, false)
        {
            handle = (IntPtr)ptr;
        }

        public unsafe SafePtr(void* ptr, bool fOwn) : base(0, fOwn)
        {
            handle = (IntPtr)ptr;
            IsOwner = fOwn;
        }

        public unsafe SafePtr(void* ptr, long size, bool fOwn) : base(0, fOwn)
        {
            handle = (IntPtr)ptr;
            Size = size;
            IsOwner = fOwn;
        ...
        public unsafe SafePtr(void* ptr, int size, bool fOwn) : base(0, fOwn)
        {
            handle = (IntPtr)ptr;
            Size = size;
            IsOwner = fOwn;
        ...
        public unsafe void Append(void* buffer, int buffLen)
        {
            ...
            Length += buffLen;
            Buffer.MemoryCopy(buffer, (void*)(handle + c), buffLen, buffLen);
        }
        ...
        {
            return (T)Marshal.PtrToStructure((IntPtr)(handle + byteIndex), typeof(T));
        }
        ...
        public virtual void FromStructAt<T>(long byteIndex, T val) where T : struct
        {
            ...
            Marshal.StructureToPtr(val, (IntPtr)(handle + byteIndex), false);
        }
        ...
        public void SetStringIndirect(long index, string value, bool addNull = true)
        {
            unsafe
            {
                char* ptr = (char*)*(IntPtr*)(handle + index);
        ...
        public string GetUTF8StringIndirect(long index)
        {
            unsafe
            {
                return internalGetUTF8String((byte*)*(IntPtr*)(handle + index));
            }
        }
        ...
        public void SetUTF8StringIndirect(long index, string value, bool addNull = true)
        {
            unsafe
            {
                internalSetUTF8String((byte*)*(IntPtr*)(handle + index), value, addNull);
            }
        }
        ...
        public virtual void Slide(long index, long length, long offset)
        {
            ...
            p1 = (IntPtr)(handle + index);
            p2 = (IntPtr)(handle + index + offset);
            ...
            p1 = (IntPtr)(handle + index + offset + length);
        ...
        public virtual long PushOut(long index, long amount, byte[] bytes = null, bool addPressure = false)
        {
            ...
            else
            {
                unsafe
                {
                    Native.ZeroMemory((void*)(handle + index), amount);
                }
            }
        ...
        public static SafePtr operator +(SafePtr val1, long val2)
        {
            val1.handle = (IntPtr)(val1.handle + val2);
            return val1;
        }
        ...
        {
            val1.handle = (IntPtr)(val1.handle + (long)val2);
            return val1;
        }
