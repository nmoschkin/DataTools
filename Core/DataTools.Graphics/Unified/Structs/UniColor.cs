...
{
    /// <summary>
    /// 32-bit color structure with customized formatting and conversion.<br />
    ///<br />
    /// Supported by a catalog of a large named color dictionary<br />
    /// with automatic named-color detection and smart opacity handling.<br />
    ///<br />
    /// This is a mutable structure.<br />
    ///<br />
    /// The structure is binary compatible with 32-bit color values,<br />
    /// and can be used in any interop call that requires such a value<br />
    /// without any modification or type coercion.<br />
    /// </summary>
    /// <remarks></remarks>
