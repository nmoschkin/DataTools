...
namespace DataTools.Win32
{
    ...
    public static class FileTools
    {
        ...
        /// </remarks>
        public static int BrowseCallback(nint hWnd, short uMsg, int wParam, int lParam)
        {
        ...
        public static void SetFileTime(string filename, FILETIME creationTime, FILETIME lastAccessTime, FILETIME lastWriteTime)
        {
            ...
            {
                hFile = IO.CreateFile(filename, IO.FILE_WRITE_ATTRIBUTES, 0, nint.Zero, IO.OPEN_EXISTING, IO.FILE_FLAG_BACKUP_SEMANTICS, nint.Zero);
            }
            else if (File.Exists(filename))
            {
                hFile = IO.CreateFile(filename, IO.FILE_WRITE_ATTRIBUTES, 0, nint.Zero, IO.OPEN_EXISTING, 0, nint.Zero);
            }
            else
            {
                return;
        ...
        public static uint GetFileSize(string fileName, ref uint lpSizeHigh)
        {
            ...
            if (!FileExists(fileName))
                return 0U;
            hFile = IO.CreateFile(fileName, IO.GENERIC_READ, 0, nint.Zero, IO.OPEN_EXISTING, 0, nint.Zero);
            if ((long)hFile == -1L)
                return 0U;
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static string GetSpecialFolder(nint hWnd, SpecialFolderConstants fSpcPath)
        {
        ...
        /// <summary>
        /// Makes an int resource (basically a new nint with a value of i).
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
        /// <remarks></remarks>
        internal static nint MAKEINTRESOURCE(int i)
        {
            return new nint(i);
        }
    }
