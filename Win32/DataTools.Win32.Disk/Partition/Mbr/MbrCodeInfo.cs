...
namespace DataTools.Win32.Disk.Partition.Mbr
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public sealed class MbrCodeInfo : IPartitionType<byte>
    {
        private static readonly string[] allOSs;
        private static readonly List<MbrCodeInfo> partCodes = new List<MbrCodeInfo>();
        ...
        static MbrCodeInfo()
        {
            ...
            foreach (var l in v)
            {
                partCodes.Add(new MbrCodeInfo(l));
            }
        ...
        /// <remarks></remarks>
        private MbrCodeInfo(string s = null)
        {
            if (s != null) Parse(s);
        }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static IReadOnlyList<MbrCodeInfo> GetCodes() => partCodes.ToArray();
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static MbrCodeInfo[] FindByCode(byte code)
        {
            var l = new List<MbrCodeInfo>();
