...
{
    internal static class BluetoothInternals
    {
        // TODO !!!

        // {0850302A-B344-4fda-9BE9-90576B8D46F0}
        public static readonly Guid GUID_BTHPORT_DEVICE_INTERFACE = new Guid(0x850302AU, 0xB344, 0x4FDA, 0x9B, 0xE9, 0x90, 0x57, 0x6B, 0x8D, 0x46, 0xF0);

        // RFCOMM device interface GUID for RFCOMM services
        // {b142fc3e-fa4e-460b-8abc-072b628b3c70}
        public static readonly Guid GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE = new Guid(0xB142FC3E, 0xFA4E, 0x460B, 0x8A, 0xBC, 0x7, 0x2B, 0x62, 0x8B, 0x3C, 0x70);

        // {EA3B5B82-26EE-450E-B0D8-D26FE30A3869}
        public static readonly Guid GUID_BLUETOOTH_RADIO_IN_RANGE = new Guid(0xEA3B5B82, 0x26EE, 0x450E, 0xB0, 0xD8, 0xD2, 0x6F, 0xE3, 0xA, 0x38, 0x69);

        // {E28867C9-C2AA-4CED-B969-4570866037C4}
        public static readonly Guid GUID_BLUETOOTH_RADIO_OUT_OF_RANGE = new Guid(0xE28867C9, 0xC2AA, 0x4CED, 0xB9, 0x69, 0x45, 0x70, 0x86, 0x60, 0x37, 0xC4);

        // {7EAE4030-B709-4AA8-AC55-E953829C9DAA}
        public static readonly Guid GUID_BLUETOOTH_L2CAP_EVENT = new Guid(0x7EAE4030U, 0xB709, 0x4AA8, 0xAC, 0x55, 0xE9, 0x53, 0x82, 0x9C, 0x9D, 0xAA);

        // {FC240062-1541-49BE-B463-84C4DCD7BF7F}
        public static readonly Guid GUID_BLUETOOTH_HCI_EVENT = new Guid(0xFC240062, 0x1541, 0x49BE, 0xB4, 0x63, 0x84, 0xC4, 0xDC, 0xD7, 0xBF, 0x7F);

        //
        // Support added in KB942567

        // {5DC9136D-996C-46DB-84F5-32C0A3F47352}
        public static readonly Guid GUID_BLUETOOTH_AUTHENTICATION_REQUEST = new Guid(0x5DC9136DU, 0x996C, 0x46DB, 0x84, 0xF5, 0x32, 0xC0, 0xA3, 0xF4, 0x73, 0x52);

        // {D668DFCD-0F4E-4EFC-BFE0-392EEEC5109C}
        public static readonly Guid GUID_BLUETOOTH_KEYPRESS_EVENT = new Guid(0xD668DFCD, 0xF4E, 0x4EFC, 0xBF, 0xE0, 0x39, 0x2E, 0xEE, 0xC5, 0x10, 0x9C);

        // {547247e6-45bb-4c33-af8c-c00efe15a71d}
        public static readonly Guid GUID_BLUETOOTH_HCI_VENDOR_EVENT = new Guid(0x547247E6, 0x45BB, 0x4C33, 0xAF, 0x8C, 0xC0, 0xE, 0xFE, 0x15, 0xA7, 0x1D);

        //
        // Bluetooth base UUID for service discovery
        //
        public static readonly Guid Bluetooth_Base_UUID = new Guid(0x0, 0x0, 0x1000, 0x80, 0x0, 0x0, 0x80, 0x5F, 0x9B, 0x34, 0xFB);
        ...
        public static readonly Guid SDP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(SDP_PROTOCOL_UUID16);
        public static readonly Guid UDP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(UDP_PROTOCOL_UUID16);
        public static readonly Guid RFCOMM_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(RFCOMM_PROTOCOL_UUID16);
        public static readonly Guid TCP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(TCP_PROTOCOL_UUID16);
        public static readonly Guid TCSBIN_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(TCSBIN_PROTOCOL_UUID16);
        public static readonly Guid TCSAT_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(TCSAT_PROTOCOL_UUID16);
        public static readonly Guid ATT_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(ATT_PROTOCOL_UUID16);
        public static readonly Guid OBEX_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(OBEX_PROTOCOL_UUID16);
        public static readonly Guid IP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(IP_PROTOCOL_UUID16);
        public static readonly Guid FTP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(FTP_PROTOCOL_UUID16);
        public static readonly Guid HTTP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(HTTP_PROTOCOL_UUID16);
        public static readonly Guid WSP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(WSP_PROTOCOL_UUID16);
        public static readonly Guid BNEP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(BNEP_PROTOCOL_UUID16);
        public static readonly Guid UPNP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(UPNP_PROTOCOL_UUID16);
        public static readonly Guid HID_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(HID_PROTOCOL_UUID16);
        public static readonly Guid HCCC_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(HCCC_PROTOCOL_UUID16);
        public static readonly Guid HCDC_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(HCDC_PROTOCOL_UUID16);
        public static readonly Guid HCN_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(HCN_PROTOCOL_UUID16);
        public static readonly Guid AVCTP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(AVCTP_PROTOCOL_UUID16);
        public static readonly Guid AVDTP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(AVDTP_PROTOCOL_UUID16);
        public static readonly Guid CMPT_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(CMPT_PROTOCOL_UUID16);
        public static readonly Guid UDI_C_PLANE_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(UDI_C_PLANE_PROTOCOL_UUID16);
        public static readonly Guid L2CAP_PROTOCOL_UUID = DEFINE_BLUETOOTH_UUID128(L2CAP_PROTOCOL_UUID16);
        ...
        public static readonly Guid ServiceDiscoveryServerServiceClassID_UUID = DEFINE_BLUETOOTH_UUID128(ServiceDiscoveryServerServiceClassID_UUID16);
        public static readonly Guid BrowseGroupDescriptorServiceClassID_UUID = DEFINE_BLUETOOTH_UUID128(BrowseGroupDescriptorServiceClassID_UUID16);
        public static readonly Guid PublicBrowseGroupServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PublicBrowseGroupServiceClassID_UUID16);
        public static readonly Guid SerialPortServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(SerialPortServiceClassID_UUID16);
        public static readonly Guid LANAccessUsingPPPServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(LANAccessUsingPPPServiceClassID_UUID16);
        public static readonly Guid DialupNetworkingServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(DialupNetworkingServiceClassID_UUID16);
        public static readonly Guid IrMCSyncServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(IrMCSyncServiceClassID_UUID16);
        public static readonly Guid OBEXObjectPushServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(OBEXObjectPushServiceClassID_UUID16);
        public static readonly Guid OBEXFileTransferServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(OBEXFileTransferServiceClassID_UUID16);
        public static readonly Guid IrMCSyncCommandServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(IrMcSyncCommandServiceClassID_UUID16);
        public static readonly Guid HeadsetServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HeadsetServiceClassID_UUID16);
        public static readonly Guid CordlessTelephonyServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(CordlessTelephonyServiceClassID_UUID16);
        public static readonly Guid AudioSourceServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AudioSourceServiceClassID_UUID16);
        public static readonly Guid AudioSinkServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AudioSinkServiceClassID_UUID16);
        public static readonly Guid AVRemoteControlTargetServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AVRemoteControlTargetServiceClassID_UUID16);
        public static readonly Guid AVRemoteControlServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AVRemoteControlServiceClassID_UUID16);
        public static readonly Guid AVRemoteControlControllerServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AVRemoteControlControllerServiceClass_UUID16);
        public static readonly Guid IntercomServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(IntercomServiceClassID_UUID16);
        public static readonly Guid FaxServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(FaxServiceClassID_UUID16);
        public static readonly Guid HeadsetAudioGatewayServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HeadsetAudioGatewayServiceClassID_UUID16);
        public static readonly Guid WAPServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(WAPServiceClassID_UUID16);
        public static readonly Guid WAPClientServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(WAPClientServiceClassID_UUID16);
        public static readonly Guid PANUServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PANUServiceClassID_UUID16);
        public static readonly Guid NAPServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(NAPServiceClassID_UUID16);
        public static readonly Guid GNServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GNServiceClassID_UUID16);
        public static readonly Guid DirectPrintingServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(DirectPrintingServiceClassID_UUID16);
        public static readonly Guid ReferencePrintingServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ReferencePrintingServiceClassID_UUID16);
        public static readonly Guid ImagingResponderServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ImagingResponderServiceClassID_UUID16);
        public static readonly Guid ImagingAutomaticArchiveServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ImagingAutomaticArchiveServiceClassID_UUID16);
        public static readonly Guid ImagingReferenceObjectsServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ImagingReferenceObjectsServiceClassID_UUID16);
        public static readonly Guid HandsfreeServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HandsfreeServiceClassID_UUID16);
        public static readonly Guid HandsfreeAudioGatewayServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HandsfreeAudioGatewayServiceClassID_UUID16);
        public static readonly Guid DirectPrintingReferenceObjectsServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(DirectPrintingReferenceObjectsServiceClassID_UUID16);
        public static readonly Guid ReflectedUIServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ReflectsUIServiceClassID_UUID16);
        public static readonly Guid PrintingStatusServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PrintingStatusServiceClassID_UUID16);
        public static readonly Guid HumanInterfaceDeviceServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HumanInterfaceDeviceServiceClassID_UUID16);
        public static readonly Guid HCRPrintServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HCRPrintServiceClassID_UUID16);
        public static readonly Guid HCRScanServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HCRScanServiceClassID_UUID16);
        public static readonly Guid CommonISDNAccessServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(CommonISDNAccessServiceClassID_UUID16);
        public static readonly Guid VideoConferencingGWServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(VideoConferencingGWServiceClassID_UUID16);
        public static readonly Guid UDIMTServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(UDIMTServiceClassID_UUID16);
        public static readonly Guid UDITAServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(UDITAServiceClassID_UUID16);
        public static readonly Guid AudioVideoServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(AudioVideoServiceClassID_UUID16);
        public static readonly Guid SimAccessServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(SimAccessServiceClassID_UUID16);
        public static readonly Guid PhonebookAccessPceServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PhonebookAccessPceServiceClassID_UUID16);
        public static readonly Guid PhonebookAccessPseServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PhonebookAccessPseServiceClassID_UUID16);
        public static readonly Guid HeadsetHSServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HeadsetHSServiceClassID_UUID16);
        public static readonly Guid MessageAccessServerServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(MessageAccessServerServiceClassID_UUID16);
        public static readonly Guid MessageNotificationServerServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(MessageNotificationServerServiceClassID_UUID16);
        public static readonly Guid GNSSServerServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GNSSServerServiceClassID_UUID16);
        public static readonly Guid ThreeDimensionalDisplayServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ThreeDimensionalDisplayServiceClassID_UUID16);
        public static readonly Guid ThreeDimensionalGlassesServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ThreeDimensionalGlassesServiceClassID_UUID16);
        public static readonly Guid MPSServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(MPSServiceClassID_UUID16);
        public static readonly Guid CTNAccessServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(CTNAccessServiceClassID_UUID16);
        public static readonly Guid CTNNotificationServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(CTNNotificationServiceClassID_UUID16);
        public static readonly Guid PnPInformationServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(PnPInformationServiceClassID_UUID16);
        public static readonly Guid GenericNetworkingServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GenericNetworkingServiceClassID_UUID16);
        public static readonly Guid GenericFileTransferServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GenericFileTransferServiceClassID_UUID16);
        public static readonly Guid GenericAudioServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GenericAudioServiceClassID_UUID16);
        public static readonly Guid GenericTelephonyServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(GenericTelephonyServiceClassID_UUID16);
        public static readonly Guid UPnpServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(UPnpServiceClassID_UUID16);
        public static readonly Guid UPnpIpServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(UPnpIpServiceClassID_UUID16);
        public static readonly Guid ESdpUpnpIpPanServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ESdpUpnpIpPanServiceClassID_UUID16);
        public static readonly Guid ESdpUpnpIpLapServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ESdpUpnpIpLapServiceClassID_UUID16);
        public static readonly Guid ESdpUpnpL2capServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(ESdpUpnpL2capServiceClassID_UUID16);
        public static readonly Guid VideoSourceServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(VideoSourceServiceClassID_UUID16);
        public static readonly Guid VideoSinkServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(VideoSinkServiceClassID_UUID16);
        public static readonly Guid HealthDeviceProfileSourceServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HealthDeviceProfileSourceServiceClassID_UUID16);
        public static readonly Guid HealthDeviceProfileSinkServiceClass_UUID = DEFINE_BLUETOOTH_UUID128(HealthDeviceProfileSinkServiceClassID_UUID16);
        ...
        public static readonly Guid AdvancedAudioDistributionProfile_UUID = DEFINE_BLUETOOTH_UUID128(AdvancedAudioDistributionProfileID_UUID16);
        public static readonly Guid ImagingServiceProfile_UUID = DEFINE_BLUETOOTH_UUID128(ImagingServiceProfileID_UUID16);
        public static readonly Guid BasicPrintingProfile_UUID = DEFINE_BLUETOOTH_UUID128(BasicPrintingProfileID_UUID16);
        public static readonly Guid HardcopyCableReplacementProfile_UUID = DEFINE_BLUETOOTH_UUID128(HardcopyCableReplacementProfileID_UUID16);
        public static readonly Guid PhonebookAccessProfile_UUID = DEFINE_BLUETOOTH_UUID128(PhonebookAccessProfileID_UUID16);
        public static readonly Guid MessageAccessProfile_UUID = DEFINE_BLUETOOTH_UUID128(MessageAccessProfileID_UUID16);
        public static readonly Guid GNSSProfile_UUID = DEFINE_BLUETOOTH_UUID128(GNSSProfileID_UUID16);
        public static readonly Guid ThreeDimensionalSynchronizationProfile_UUID = DEFINE_BLUETOOTH_UUID128(ThreeDimensionalSynchronizationProfileID_UUID16);
        public static readonly Guid MPSProfile_UUID = DEFINE_BLUETOOTH_UUID128(MPSProfileID_UUID16);
        public static readonly Guid CTNProfile_UUID = DEFINE_BLUETOOTH_UUID128(CTNProfileID_UUID16);
        public static readonly Guid VideoDistributionProfile_UUID = DEFINE_BLUETOOTH_UUID128(VideoDistributionProfileID_UUID16);
        public static readonly Guid HealthDeviceProfile_UUID = DEFINE_BLUETOOTH_UUID128(HealthDeviceProfileID_UUID16);

        //
        // The SIG renamed the uuid for VideoConferencingServiceClass
        //
        public static readonly Guid VideoConferencingServiceClass_UUID = AVRemoteControlControllerServiceClass_UUID;

        public static readonly ushort VideoConferencingServiceClassID_UUID16 = AVRemoteControlControllerServiceClass_UUID16;

        //
        // Fixing typos introduced in previous releases
        //
        public static readonly Guid HN_PROTOCOL_UUID = HCN_PROTOCOL_UUID;

        public static readonly Guid BasicPringingServiceClass_UUID = BasicPrintingProfile_UUID;

        //
        // Fixing naming inconsistencies in UUID16 list
        //
        public static readonly ushort CommonISDNAccessServiceClass_UUID16 = CommonISDNAccessServiceClassID_UUID16;

        public static readonly ushort VideoConferencingGWServiceClass_UUID16 = VideoConferencingGWServiceClassID_UUID16;
        public static readonly ushort UDIMTServiceClass_UUID16 = UDIMTServiceClassID_UUID16;
        public static readonly ushort UDITAServiceClass_UUID16 = UDITAServiceClassID_UUID16;
        public static readonly ushort AudioVideoServiceClass_UUID16 = AudioVideoServiceClassID_UUID16;

        //
        // Fixing naming inconsistencies in profile list
        //
        public static readonly ushort CordlessServiceClassID_UUID16 = CordlessTelephonyServiceClassID_UUID16;

        public static readonly ushort AudioSinkSourceServiceClassID_UUID16 = AudioSinkServiceClassID_UUID16;
        public static readonly ushort AdvancedAudioDistributionServiceClassID_UUID16 = AdvancedAudioDistributionProfileID_UUID16;
        public static readonly ushort ImagingServiceClassID_UUID16 = ImagingServiceProfileID_UUID16;
        public static readonly ushort BasicPrintingServiceClassID_UUID16 = BasicPrintingProfileID_UUID16;
        public static readonly ushort HardcopyCableReplacementServiceClassID_UUID16 = HardcopyCableReplacementProfileID_UUID16;
        public static readonly Guid AdvancedAudioDistributionServiceClass_UUID = AdvancedAudioDistributionProfile_UUID;
        public static readonly Guid ImagingServiceClass_UUID = ImagingServiceProfile_UUID;
        public static readonly Guid BasicPrintingServiceClass_UUID = BasicPrintingProfile_UUID;
        public static readonly Guid HardcopyCableReplacementServiceClass_UUID = HardcopyCableReplacementProfile_UUID;
        public static readonly Guid VideoDistributionServiceClass_UUID = VideoDistributionProfile_UUID;
        ...
        // Manufacturers
        public static readonly BTH_MFG_INFO BTH_MFG_ERICSSON = new BTH_MFG_INFO("Ericsson", 0);

        public static readonly BTH_MFG_INFO BTH_MFG_NOKIA = new BTH_MFG_INFO("Nokia", 1);
        public static readonly BTH_MFG_INFO BTH_MFG_INTEL = new BTH_MFG_INFO("Intel", 2);
        public static readonly BTH_MFG_INFO BTH_MFG_IBM = new BTH_MFG_INFO("IBM", 3);
        public static readonly BTH_MFG_INFO BTH_MFG_TOSHIBA = new BTH_MFG_INFO("Toshiba", 4);
        public static readonly BTH_MFG_INFO BTH_MFG_3COM = new BTH_MFG_INFO("3COM", 5);
        public static readonly BTH_MFG_INFO BTH_MFG_MICROSOFT = new BTH_MFG_INFO("Microsoft", 6);
        public static readonly BTH_MFG_INFO BTH_MFG_LUCENT = new BTH_MFG_INFO("Lucent", 7);
        public static readonly BTH_MFG_INFO BTH_MFG_MOTOROLA = new BTH_MFG_INFO("Motorola", 8);
        public static readonly BTH_MFG_INFO BTH_MFG_INFINEON = new BTH_MFG_INFO("Infineon", 9);
        public static readonly BTH_MFG_INFO BTH_MFG_CSR = new BTH_MFG_INFO("CSR", 10);
        public static readonly BTH_MFG_INFO BTH_MFG_SILICONWAVE = new BTH_MFG_INFO("SiliconWave", 11);
        public static readonly BTH_MFG_INFO BTH_MFG_DIGIANSWER = new BTH_MFG_INFO("DigiAnswer", 12);
        public static readonly BTH_MFG_INFO BTH_MFG_TI = new BTH_MFG_INFO("TI", 13);
        public static readonly BTH_MFG_INFO BTH_MFG_PARTHUS = new BTH_MFG_INFO("Parthus", 14);
        public static readonly BTH_MFG_INFO BTH_MFG_BROADCOM = new BTH_MFG_INFO("Broadcom", 15);
        public static readonly BTH_MFG_INFO BTH_MFG_MITEL = new BTH_MFG_INFO("MITEL", 16);
        public static readonly BTH_MFG_INFO BTH_MFG_WIDCOMM = new BTH_MFG_INFO("Widcomm", 17);
        public static readonly BTH_MFG_INFO BTH_MFG_ZEEVO = new BTH_MFG_INFO("Zeevo", 18);
        public static readonly BTH_MFG_INFO BTH_MFG_ATMEL = new BTH_MFG_INFO("ATMEL", 19);
        public static readonly BTH_MFG_INFO BTH_MFG_MITSIBUSHI = new BTH_MFG_INFO("Mitsibushi", 20);
        public static readonly BTH_MFG_INFO BTH_MFG_RTX_TELECOM = new BTH_MFG_INFO("RTX Telecom", 21);
        public static readonly BTH_MFG_INFO BTH_MFG_KC_TECHNOLOGY = new BTH_MFG_INFO("KC Technology", 22);
        public static readonly BTH_MFG_INFO BTH_MFG_NEWLOGIC = new BTH_MFG_INFO("NewLogic", 23);
        public static readonly BTH_MFG_INFO BTH_MFG_TRANSILICA = new BTH_MFG_INFO("Transilica", 24);
        public static readonly BTH_MFG_INFO BTH_MFG_ROHDE_SCHWARZ = new BTH_MFG_INFO("Rohde Schwarz", 25);
        public static readonly BTH_MFG_INFO BTH_MFG_TTPCOM = new BTH_MFG_INFO("TTPCOM", 26);
        public static readonly BTH_MFG_INFO BTH_MFG_SIGNIA = new BTH_MFG_INFO("Signia", 27);
        public static readonly BTH_MFG_INFO BTH_MFG_CONEXANT = new BTH_MFG_INFO("Conexant", 28);
        public static readonly BTH_MFG_INFO BTH_MFG_QUALCOMM = new BTH_MFG_INFO("Qualcomm", 29);
        public static readonly BTH_MFG_INFO BTH_MFG_INVENTEL = new BTH_MFG_INFO("INVENTEL", 30);
        public static readonly BTH_MFG_INFO BTH_MFG_AVM_BERLIN = new BTH_MFG_INFO("AVM Berlin", 31);
        public static readonly BTH_MFG_INFO BTH_MFG_BANDSPEED = new BTH_MFG_INFO("Bandspeed", 32);
        public static readonly BTH_MFG_INFO BTH_MFG_MANSELLA = new BTH_MFG_INFO("Mansella", 33);
        public static readonly BTH_MFG_INFO BTH_MFG_NEC = new BTH_MFG_INFO("NEC", 34);
        public static readonly BTH_MFG_INFO BTH_MFG_WAVEPLUS_TECHNOLOGY_CO = new BTH_MFG_INFO("WavePlus Technology Co", 35);
        public static readonly BTH_MFG_INFO BTH_MFG_ALCATEL = new BTH_MFG_INFO("ALCATEL", 36);
        public static readonly BTH_MFG_INFO BTH_MFG_PHILIPS_SEMICONDUCTOR = new BTH_MFG_INFO("Philips Semiconductor", 37);
        public static readonly BTH_MFG_INFO BTH_MFG_C_TECHNOLOGIES = new BTH_MFG_INFO("C Technologies", 38);
        public static readonly BTH_MFG_INFO BTH_MFG_OPEN_INTERFACE = new BTH_MFG_INFO("Open Interface", 39);
        public static readonly BTH_MFG_INFO BTH_MFG_RF_MICRO_DEVICES = new BTH_MFG_INFO("RF Micro Devices", 40);
        public static readonly BTH_MFG_INFO BTH_MFG_HITACHI = new BTH_MFG_INFO("Hitachi", 41);
        public static readonly BTH_MFG_INFO BTH_MFG_SYMBOL_TECHNOLOGIES = new BTH_MFG_INFO("Symbol Technologies", 42);
        public static readonly BTH_MFG_INFO BTH_MFG_TENOVIS = new BTH_MFG_INFO("Tenovis", 43);
        public static readonly BTH_MFG_INFO BTH_MFG_MACRONIX_INTERNATIONAL = new BTH_MFG_INFO("Macronix International", 44);
        public static readonly BTH_MFG_INFO BTH_MFG_MARVELL = new BTH_MFG_INFO("Marvell", 72);
        public static readonly BTH_MFG_INFO BTH_MFG_APPLE = new BTH_MFG_INFO("Apple", 76);
        public static readonly BTH_MFG_INFO BTH_MFG_NORDIC_SEMICONDUCTORS_ASA = new BTH_MFG_INFO("Nordic Semiconductors ASA", 89);
        public static readonly BTH_MFG_INFO BTH_MFG_ARUBA_NETWORKS = new BTH_MFG_INFO("Aruba Networks", 283);
        public static readonly BTH_MFG_INFO BTH_MFG_INTERNAL_USE = new BTH_MFG_INFO("INTERNAL_USE", 65535);
        ...
        public static readonly int COD_SERVICE_MAX_COUNT = 9;
        ...
        //
        public static readonly byte[] LAP_GIAC_INIT = new byte[] { 0x33, 0x8B, 0x9E };

        public static readonly byte[] LAP_LIAC_INIT = new byte[] { 0x0, 0x8B, 0x9E };
        ...
        public static readonly uint HCI_CONNECTION_TYPE_ACL = 1U;
        public static readonly uint HCI_CONNECTION_TYPE_SCO = 2U;
        public static readonly uint HCI_CONNECTION_TYPE_LE = 3U;

        //
        // Fix typos
        //
        public static readonly uint HCI_CONNNECTION_TYPE_ACL = HCI_CONNECTION_TYPE_ACL;

        public static readonly uint HCI_CONNNECTION_TYPE_SCO = HCI_CONNECTION_TYPE_SCO;
        ...
        public static readonly uint SDP_ATTRIB_RECORD_HANDLE = 0x0;
        public static readonly uint SDP_ATTRIB_CLASS_ID_LIST = 0x1;
        public static readonly uint SDP_ATTRIB_RECORD_STATE = 0x2;
        public static readonly uint SDP_ATTRIB_SERVICE_ID = 0x3;
        public static readonly uint SDP_ATTRIB_PROTOCOL_DESCRIPTOR_LIST = 0x4;
        public static readonly uint SDP_ATTRIB_BROWSE_GROUP_LIST = 0x5;
        public static readonly uint SDP_ATTRIB_LANG_BASE_ATTRIB_ID_LIST = 0x6;
        public static readonly uint SDP_ATTRIB_INFO_TIME_TO_LIVE = 0x7;
        public static readonly uint SDP_ATTRIB_AVAILABILITY = 0x8;
        public static readonly uint SDP_ATTRIB_PROFILE_DESCRIPTOR_LIST = 0x9;
        public static readonly uint SDP_ATTRIB_DOCUMENTATION_URL = 0xA;
        public static readonly uint SDP_ATTRIB_CLIENT_EXECUTABLE_URL = 0xB;
        public static readonly uint SDP_ATTRIB_ICON_URL = 0xC;
        ...
        //
        public static readonly uint SDP_ATTRIB_PROFILE_SPECIFIC = 0x200;

        public static readonly uint LANG_BASE_LANGUAGE_INDEX = 0x0;
        public static readonly uint LANG_BASE_ENCODING_INDEX = 0x1;
        public static readonly uint LANG_BASE_OFFSET_INDEX = 0x2;
        public static readonly uint LANG_DEFAULT_ID = 0x100;
        public static readonly uint LANGUAGE_EN_US = 0x656E;
        public static readonly uint ENCODING_UTF_8 = 0x6A;
        public static readonly uint STRING_NAME_OFFSET = 0x0;
        public static readonly uint STRING_DESCRIPTION_OFFSET = 0x1;
        public static readonly uint STRING_PROVIDER_NAME_OFFSET = 0x2;
        public static readonly uint SDP_ATTRIB_SDP_VERSION_NUMBER_LIST = 0x200;
        public static readonly uint SDP_ATTRIB_SDP_DATABASE_STATE = 0x201;
        public static readonly uint SDP_ATTRIB_BROWSE_GROUP_ID = 0x200;
        public static readonly uint SDP_ATTRIB_CORDLESS_EXTERNAL_NETWORK = 0x301;
        public static readonly uint SDP_ATTRIB_FAX_CLASS_1_SUPPORT = 0x302;
        public static readonly uint SDP_ATTRIB_FAX_CLASS_2_0_SUPPORT = 0x303;
        public static readonly uint SDP_ATTRIB_FAX_CLASS_2_SUPPORT = 0x304;
        public static readonly uint SDP_ATTRIB_FAX_AUDIO_FEEDBACK_SUPPORT = 0x305;
        public static readonly uint SDP_ATTRIB_HEADSET_REMOTE_AUDIO_VOLUME_CONTROL = 0x302;
        public static readonly uint SDP_ATTRIB_LAN_LPSUBNET = 0x200;
        public static readonly uint SDP_ATTRIB_OBJECT_PUSH_SUPPORTED_FORMATS_LIST = 0x303;
        public static readonly uint SDP_ATTRIB_SYNCH_SUPPORTED_DATA_STORES_LIST = 0x301;

        //  this is in the assigned numbers doc, but it does not show up in any profile
        public static readonly uint SDP_ATTRIB_SERVICE_VERSION = 0x300;

        public static readonly uint SDP_ATTRIB_PAN_NETWORK_ADDRESS = 0x306;
        public static readonly uint SDP_ATTRIB_PAN_WAP_GATEWAY = 0x307;
        public static readonly uint SDP_ATTRIB_PAN_HOME_PAGE_URL = 0x308;
        public static readonly uint SDP_ATTRIB_PAN_WAP_STACK_TYPE = 0x309;
        public static readonly uint SDP_ATTRIB_PAN_SECURITY_DESCRIPTION = 0x30A;
        public static readonly uint SDP_ATTRIB_PAN_NET_ACCESS_TYPE = 0x30B;
        public static readonly uint SDP_ATTRIB_PAN_MAX_NET_ACCESS_RATE = 0x30C;
        public static readonly uint SDP_ATTRIB_IMAGING_SUPPORTED_CAPABILITIES = 0x310;
        public static readonly uint SDP_ATTRIB_IMAGING_SUPPORTED_FEATURES = 0x311;
        public static readonly uint SDP_ATTRIB_IMAGING_SUPPORTED_FUNCTIONS = 0x312;
        public static readonly uint SDP_ATTRIB_IMAGING_TOTAL_DATA_CAPACITY = 0x313;
        public static readonly uint SDP_ATTRIB_DI_SPECIFICATION_ID = 0x200;
        public static readonly uint SDP_ATTRIB_DI_VENDOR_ID = 0x201;
        public static readonly uint SDP_ATTRIB_DI_PRODUCT_ID = 0x202;
        public static readonly uint SDP_ATTRIB_DI_VERSION = 0x203;
        public static readonly uint SDP_ATTRIB_DI_PRIMARY_RECORD = 0x204;
        public static readonly uint SDP_ATTRIB_DI_VENDOR_ID_SOURCE = 0x205;
        public static readonly uint SDP_ATTRIB_HID_DEVICE_RELEASE_NUMBER = 0x200;
        public static readonly uint SDP_ATTRIB_HID_PARSER_VERSION = 0x201;
        public static readonly uint SDP_ATTRIB_HID_DEVICE_SUBCLASS = 0x202;
        public static readonly uint SDP_ATTRIB_HID_COUNTRY_CODE = 0x203;
        public static readonly uint SDP_ATTRIB_HID_VIRTUAL_CABLE = 0x204;
        public static readonly uint SDP_ATTRIB_HID_RECONNECT_INITIATE = 0x205;
        public static readonly uint SDP_ATTRIB_HID_DESCRIPTOR_LIST = 0x206;
        public static readonly uint SDP_ATTRIB_HID_LANG_ID_BASE_LIST = 0x207;
        public static readonly uint SDP_ATTRIB_HID_SDP_DISABLE = 0x208;
        public static readonly uint SDP_ATTRIB_HID_BATTERY_POWER = 0x209;
        public static readonly uint SDP_ATTRIB_HID_REMOTE_WAKE = 0x20A;
        public static readonly uint SDP_ATTRIB_HID_PROFILE_VERSION = 0x20B;
        public static readonly uint SDP_ATTRIB_HID_SUPERVISION_TIMEOUT = 0x20C;
        public static readonly uint SDP_ATTRIB_HID_NORMALLY_CONNECTABLE = 0x20D;
        public static readonly uint SDP_ATTRIB_HID_BOOT_DEVICE = 0x20E;
        public static readonly uint SDP_ATTRIB_HID_SSR_HOST_MAX_LATENCY = 0x20F;
        public static readonly uint SDP_ATTRIB_HID_SSR_HOST_MIN_TIMEOUT = 0x210;
        public static readonly uint SDP_ATTRIB_A2DP_SUPPORTED_FEATURES = 0x311;
        public static readonly uint SDP_ATTRIB_AVRCP_SUPPORTED_FEATURES = 0x311;
        public static readonly uint SDP_ATTRIB_HFP_SUPPORTED_FEATURES = 0x311;

        //
        // Profile specific values
        //
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CATEGORY_1 = 0x1;

        public static readonly uint AVRCP_SUPPORTED_FEATURES_CATEGORY_2 = 0x2;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CATEGORY_3 = 0x4;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CATEGORY_4 = 0x8;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CT_BROWSING = 0x40;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CT_COVER_ART_IMAGE_PROPERTIES = 0x80;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CT_COVER_ART_IMAGE = 0x100;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_CT_COVER_ART_LINKED_THUMBNAIL = 0x200;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_TG_PLAYER_APPLICATION_SETTINGS = 0x10;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_TG_GROUP_NAVIGATION = 0x20;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_TG_BROWSING = 0x40;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_TG_MULTIPLE_PLAYER_APPLICATIONS = 0x80;
        public static readonly uint AVRCP_SUPPORTED_FEATURES_TG_COVER_ART = 0x100;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_PSTN = 0x1;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_ISDN = 0x2;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_GSM = 0x3;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_CDMA = 0x4;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_ANALOG_CELLULAR = 0x5;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_PACKET_SWITCHED = 0x6;
        public static readonly uint CORDLESS_EXTERNAL_NETWORK_OTHER = 0x7;
        public static readonly uint OBJECT_PUSH_FORMAT_VCARD_2_1 = 0x1;
        public static readonly uint OBJECT_PUSH_FORMAT_VCARD_3_0 = 0x2;
        public static readonly uint OBJECT_PUSH_FORMAT_VCAL_1_0 = 0x3;
        public static readonly uint OBJECT_PUSH_FORMAT_ICAL_2_0 = 0x4;
        public static readonly uint OBJECT_PUSH_FORMAT_VNOTE = 0x5;
        public static readonly uint OBJECT_PUSH_FORMAT_VMESSAGE = 0x6;
        public static readonly uint OBJECT_PUSH_FORMAT_ANY = 0xFF;
        public static readonly uint SYNCH_DATA_STORE_PHONEBOOK = 0x1;
        public static readonly uint SYNCH_DATA_STORE_CALENDAR = 0x3;
        public static readonly uint SYNCH_DATA_STORE_NOTES = 0x5;
        public static readonly uint SYNCH_DATA_STORE_MESSAGES = 0x6;
        public static readonly uint DI_VENDOR_ID_SOURCE_BLUETOOTH_SIG = 0x1;
        public static readonly uint DI_VENDOR_ID_SOURCE_USB_IF = 0x2;
        public static readonly uint PSM_SDP = 0x1;
        public static readonly uint PSM_RFCOMM = 0x3;
        public static readonly uint PSM_TCS_BIN = 0x5;
        public static readonly uint PSM_TCS_BIN_CORDLESS = 0x7;
        public static readonly uint PSM_BNEP = 0xF;
        public static readonly uint PSM_HID_CONTROL = 0x11;
        public static readonly uint PSM_HID_INTERRUPT = 0x13;
        public static readonly uint PSM_UPNP = 0x15;
        public static readonly uint PSM_AVCTP = 0x17;
        public static readonly uint PSM_AVDTP = 0x19;
        public static readonly uint PSM_AVCTP_BROWSE = 0x1B;
        public static readonly uint PSM_UDI_C_PLANE = 0x1D;
        public static readonly uint PSM_ATT = 0x1F;
        public static readonly uint PSM_3DSP = 0x21;
        public static readonly uint PSM_LE_IPSP = 0x23;
        ...
        // IOCTL defines.
        //
        public static readonly uint BTH_IOCTL_BASE = 0U;
        ...
        //
        public static readonly CTL_CODE IOCTL_INTERNAL_BTH_SUBMIT_BRB = BTH_KERNEL_CTL((uint)(BTH_IOCTL_BASE + 0x0L));

        //
        // Input:  none
        // Output:  BTH_ENUMERATOR_INFO
        //
        public static readonly CTL_CODE IOCTL_INTERNAL_BTHENUM_GET_ENUMINFO = BTH_KERNEL_CTL((uint)(BTH_IOCTL_BASE + 0x1L));

        //
        // Input:  none
        // Output:  BTH_DEVICE_INFO
        //
        public static readonly CTL_CODE IOCTL_INTERNAL_BTHENUM_GET_DEVINFO = BTH_KERNEL_CTL((uint)(BTH_IOCTL_BASE + 0x2L));
        ...
        //
        public static readonly CTL_CODE IOCTL_BTH_GET_LOCAL_INFO = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x0L));

        //
        // Input:  BTH_ADDR
        // Output:  BTH_RADIO_INFO
        //
        public static readonly CTL_CODE IOCTL_BTH_GET_RADIO_INFO = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x1L));
        ...
        //
        public static readonly CTL_CODE IOCTL_BTH_GET_DEVICE_INFO = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x2L));

        //
        // Input:  BTH_ADDR
        // Output:  none
        //
        public static readonly CTL_CODE IOCTL_BTH_DISCONNECT_DEVICE = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x3L));

        //
        // Input:   BTH_VENDOR_SPECIFIC_COMMAND
        // Output:  PVOID
        //
        public static readonly CTL_CODE IOCTL_BTH_HCI_VENDOR_COMMAND = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x14L));

        //
        // Input:  BTH_SDP_CONNECT
        // Output:  BTH_SDP_CONNECT
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_CONNECT = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x80L));

        //
        // Input:  HANDLE_SDP
        // Output:  none
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_DISCONNECT = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x81L));

        //
        // Input:  BTH_SDP_SERVICE_SEARCH_REQUEST
        // Output:  ULong * number of handles wanted
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_SERVICE_SEARCH = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x82L));

        //
        // Input:  BTH_SDP_ATTRIBUTE_SEARCH_REQUEST
        // Output:  BTH_SDP_STREAM_RESPONSE Or bigger
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_ATTRIBUTE_SEARCH = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x83L));

        //
        // Input:  BTH_SDP_SERVICE_ATTRIBUTE_SEARCH_REQUEST
        // Output:  BTH_SDP_STREAM_RESPONSE Or bigger
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_SERVICE_ATTRIBUTE_SEARCH = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x84L));

        //
        // Input:  raw SDP stream (at least 2 bytes)
        // Ouptut: HANDLE_SDP
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_SUBMIT_RECORD = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x85L));

        //
        // Input:  HANDLE_SDP
        // Output:  none
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_REMOVE_RECORD = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x86L));

        //
        // Input:  BTH_SDP_RECORD + raw SDP record
        // Output:  HANDLE_SDP
        //
        public static readonly CTL_CODE IOCTL_BTH_SDP_SUBMIT_RECORD_WITH_INFO = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x87L));

        //
        // Input:  NONE
        // Output:  BTH_HOST_FEATURE_MASK
        //
        public static readonly CTL_CODE IOCTL_BTH_GET_HOST_SUPPORTED_FEATURES = BTH_CTL((uint)(BTH_IOCTL_BASE + 0x88L));
        ...
        public static readonly IntPtr HANDLE_SDP_NULL = IntPtr.Zero;
        public static readonly IntPtr HANDLE_SDP_LOCAL = new IntPtr(-2);
        ...
        public static BLUETOOTH_RADIO_INFO[] _internalEnumBluetoothRadios()
        {
            ...
            BLUETOOTH_FIND_RADIO_PARAMS radCfg;
            ...
            hFind = BluetoothFindFirstRadio(ref radCfg, out hRadio);
            ...
            do
            {
                ...
                {
                    dwSize = (ulong)Marshal.SizeOf<BLUETOOTH_RADIO_INFO>()
                };

                uint x = BluetoothGetRadioInfo(hRadio, ref brInfo);
                string s = NativeError.FormatLastError(x);
