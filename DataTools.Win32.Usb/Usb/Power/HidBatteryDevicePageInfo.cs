...
namespace DataTools.Win32.Usb
{
    public class HidBatteryDevicePageInfo : HidUsagePageInfo<HidBatteryUsageInfo>
    {
        ...
        {
            if (values[0] is int x && values.Length == 1)
            {
                base.Parse(values);
                return;
            }
        ...
        protected HidBatteryDevicePageInfo() : base(0x85)
        {
            ...
            //Parse(0x87, "ManufacturerName", "SV", "F", "R/O", "SBML", "4.2.6");
            //Parse(0x88, "Devicename", "SV", "F", "R/O", "SBML", "4.2.6");
            //Parse(0x89, "DeviceChemistry", "SV", "F", "R/O", "SBML", "4.2.6");
            ...
            //Parse(0x8F, "OEMInformation", "SV", "F", "R/O", "SBML", "4.2.7");
